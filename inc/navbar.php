    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <?php if($_SESSION["administrador"] == 0):?>
                <a class="navbar-brand" href="#" id="marca_del_producto"><?php echo $_SESSION["nombre_dependencia"] ?></a>
            <?php else: ?>
                <a class="navbar-brand" href="#" id="marca_del_producto">Administrador</a>
            <?php endif;?>
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <?php if($_SESSION["dependencia"] == 0):?>
                <li id="elem_inventarios"><a href="./dependencias"><i class="fa fa-book"></i> Dependencias</a></li>
                 <?php endif;?>
                ...
                <li id="elem_reportes" class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="./corte-caja">Corte de caja</a></li>
