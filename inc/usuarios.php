    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="contDep" class="form-group">
...
<div id="modal_formulario_cambiar_pass" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title" id="modal_change_password_dp">Cambiar contraseña</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
            ...
            <div class="modal-footer">
                <div class="row">
                    <div class="col-xs-6">
                        <button id="cambiar_dep" class="form-control btn btn-success">Cambiar</button>
                    </div>
                    <div class="col-xs-6">
                        <button id="cancelar_confirmacion_eliminar" data-dismiss="modal"
                                class="form-control btn btn-warning">Cancelar
...
<div id="modal_formulario_cambiar_dep" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title" id="modal_change_dp_title">Cambiar Dependencia</h4>
            </div>
            <div class="modal-body">
            <label for="administrador">
                        Dependencia
                    </label>
                    <select name="" id="dependencia_update" class="form-control dependencia">
                       
                    </select>
                <input type="hidden" name="" id="id-newdep">
            </div>
            <div class="modal-footer">
                <div class="row">
                    <div class="col-xs-6">
                        <button id="cambiar_dep" onclick="test()" class="form-control btn btn-success">Cambiar</button>
                    </div>
                    <div class="col-xs-6">
                        <button id="cancelar_confirmacion_eliminar" data-dismiss="modal"
                                class="form-control btn btn-warning">Cancelar
