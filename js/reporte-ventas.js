...
$(document).ready(function () {
    ...
    consulta_familias(function () {
        consulta_ventas_fecha($("#fecha_inicio").val(), $("#fecha_fin").val(), $("#familia").val(),$("#id_usuario").val(),$("#is_admin").val());
    });
...
function consulta_ventas_fecha(fecha_inicio, fecha_fin, familia,id,is_admin) {
            ...
            .append(
                $("<tr>")
                    .append(
                        ...
                        $("<td>").html(currency(ventas_totales[i].total)),
                        $("<td>").html(currency( ventas_totales[i].utilidad)),
                        $("<td>").html(ventas_totales[i].usuario)
                    )
            );
    }
    $("#contenedor_tabla").animateCss("fadeInUp");
    $("#mostrar_total").text(currency(ayudante_total)).parent().show();
    $("#mostrar_utilidad").text(currency(ayudante_utilidad)).parent().show();
