...
if (!defined("MINUTOS_EXPIRACION_SESION")) define("MINUTOS_EXPIRACION_SESION", 100 * 60);
...
if (!file_exists(RAIZ . "/config.php")) {
    ...
    if (isset($_SESSION["hora_de_inicio"]) and ((time() - $_SESSION["hora_de_inicio"]) / 10) <= MINUTOS_EXPIRACION_SESION) {
        //  if(true){
        ...
        $lista_blanca = array("pasar-inventario", "alta-de-inventarios", "caja", "clientes", "compras", "inventarios", "ventas", "reportes-inventarios", "reportes", "reportes-caja", "reportes-ventas", "gastos", "ajustes", "reportes-gastos", "reportes-bajas-inventario", "usuarios", "productos-en-stock","dependencias","corte-caja");
